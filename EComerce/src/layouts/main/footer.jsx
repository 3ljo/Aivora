...
const LINKS = [
  {
    headline: 'Shop',
    children: [
      { name: 'All Products', href: paths.product.root },
      { name: 'Checkout', href: paths.product.checkout },
      { name: 'Wishlist', href: paths.wishlist },
      { name: 'My Orders', href: paths.account.orders },
    ],
  },
  {
    headline: 'Support',
  ...
  { headline: 'Contact', children: [{ name: 'support@ecommerce.com', href: '#' }] },
];
